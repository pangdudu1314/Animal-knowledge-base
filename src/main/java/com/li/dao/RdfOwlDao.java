...
//OWLManager为owi api的管理类，
  ...
  //每一个本地都有一个唯一标识  前缀和后缀拼在一起，正好和xml本体是一致的
   ...
   IRI DONGWU = IRI.create("http://www.semanticweb.org/administrator/ontologies/2019/3/untitled-ontology-8");
  ...
  private  OWLOntology loadDongwu(OWLOntologyManager m)
    ...
    return m.loadOntologyFromOntologyDocument(new StringDocumentSource(content));//将rdf内容进行加载管理，这样 wolapi就能知道里面有什么内容
  }
