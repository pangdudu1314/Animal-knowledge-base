...
<table id="dg" class="easyui-datagrid" title="动物列表" style="width:100%;height:500px"
    ...
    <thead>
    <tr>
        <th data-options="field:'kemu',width:80">科目</th>
    ...
    <form id="ff" method="post">
        <div style="margin-bottom:10px">
            <input class="easyui-textbox" name="animalName" style="width:100%"
                   data-options="label:'动物名称:',required:true,editable:false">
        </div>
        <div style="margin-bottom:10px">
            <input class="easyui-textbox" name="animalIntro" style="width:100%"
                   data-options="label:'描述:',required:true,editable:false">
        </div>
        <div style="margin-bottom:10px">
            <input class="easyui-textbox" name="dataFrom" style="width:100%"
                   data-options="label:'数据来源:',required:true,editable:false">
        </div>
        <div style="margin-bottom:10px">
        ...
        <div style="margin-bottom:10px">
            <input class="easyui-textbox" name="kemu" style="width:100%"
                   data-options="label:'所属科目:',required:true,prompt:'请从动物开始，用中划线分割动物层级。例如:动物-鸟类-稚科'">
        </div>
        <div style="margin-bottom:10px">
...
<script>
  ...
  function _showPhoto(value, rows, index) {
    if (rows.animalImage) {
      return "<img src='${ctx}/" + rows.animalImage + "'style='width:80px;height:80px'";
    } else {
      return null
    }
  }
